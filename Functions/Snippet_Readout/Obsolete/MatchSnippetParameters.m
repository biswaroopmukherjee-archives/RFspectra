function [parameter_value,snippet_timestamp,error_message] = ...
    MatchSnippetParameters(snippet_folder,img_name,select_parameter)
...
snippet_timestamp = '01-01-0000_00_00_00';
...
%     
%     error_message = 'Image matches with entry from next day''s snippet file.';
%     
...
%     error_check_match = sum(match_vector);
%     
%     if error_check_match == 0 % if there is no match with next days file
%         error_message = 'No match found in same day and next day''s snippet file.';
%     end
%     
%     
